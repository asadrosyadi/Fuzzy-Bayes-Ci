 ...
 <div class="row">
				 ...
				 <div class="col-4">
					<div class="form-group">
                        <label class="control-label col-xs-3" >Nilai Sensor 1</label>
                        <div class="col-xs-9">
                           <input type="text" name="valsensor1" class="form-control">
                        </div>
                    </div>
				</div>
				<div class="col-4">
					<div class="form-group">
                        <label class="control-label col-xs-3" >Nilai Sensor 2</label>
                        <div class="col-xs-9">
                           <input type="text" name="valsensor2" class="form-control">
                        </div>
                    </div>
				</div>
				<div class="col-4">
					<div class="form-group">
                        <label class="control-label col-xs-3" >Nilai Sensor 3</label>
                        <div class="col-xs-9">
                           <input type="text" name="valsensor3" class="form-control">
                        </div>
                    </div>
				</div>
		...
		<tr>  
			...
			<td><?php echo anchor('fuzzybayes/hapus/'.$u->id,'<button type="button" class="btn btn-danger text-center">Hapus Data</button>'); ?></td>
		</tr>
		<?php } ?>
		</tbody>
            </table>
            ...
            ?>
                <div class="modal-body">
                    ...
                    <div class="form-group">
					 ...
					 <div class="form-group">
                        <label class="control-label col-xs-3" >Kelembaban</label>
                        <div class="col-xs-9">
                           <input type="text" name="sensor2" class="form-control">
                        </div>
                    </div>
					<div class="form-group">
                        <label class="control-label col-xs-3" >Intensitas Cahaya</label>
                        <div class="col-xs-9">
